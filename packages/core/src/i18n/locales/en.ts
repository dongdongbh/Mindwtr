...
export const en: Record<string, string> = {
        ...
        'calendar.pinCalendarWidget': 'Pin calendar to desktop',
        'calendar.pinCalendarWidgetHint': 'Pin a small month calendar to the desktop; click again to remove it',
        'calendar.pinTodayWidget': 'Pin today’s tasks note to desktop',
        'calendar.pinTodayWidgetHint': 'Pin a sticky note with today’s tasks to the desktop; click again to remove it',
        'widget.today': 'Today',
        'widget.previousMonth': 'Previous month',
        'widget.nextMonth': 'Next month',
        'widget.backToToday': 'Back to today',
        'widget.openInMainWindow': 'Open in Mindwtr',
        'widget.noTasksForDay': 'No tasks for this day',
        'widget.allClearToday': 'Nothing due today. Enjoy the clear board!',
        'widget.completedToday': 'Completed today',
        'widget.close': 'Close widget',
        'widget.lockPosition': 'Lock position (prevents dragging)',
        'widget.unlockPosition': 'Unlock position (allow dragging)',
        'widget.addTaskForDay': 'Add a task for this day…',
        'widget.clickDayToAdd': 'Click a day to add tasks',
        'widget.deleteTask': 'Delete task',
