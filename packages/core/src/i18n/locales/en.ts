...
export const en: Record<string, string> = {
  ...
  'settings.syncPreferenceGtd': 'GTD settings and defaults',
        ...
        'syncLogin.title': 'Connect to your self-hosted sync server',
        'syncLogin.submitButton': 'Connect',
        'syncLogin.connectFailed': "Couldn't connect — check your Self-Hosted URL and Access Token.",
