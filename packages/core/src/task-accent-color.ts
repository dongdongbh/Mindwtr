...
// The ONE home for a task's or project's identity colour (desktop calendar and
// timeline, the Android widget rows). Every project stores DEFAULT_PROJECT_COLOR until the user picks one; that
