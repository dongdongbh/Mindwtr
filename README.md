...
- WebDAV servers must return strong ETags for files. Mindwtr checks this during connection setup and refuses providers that cannot safely prevent one device from overwriting another device’s generation.
